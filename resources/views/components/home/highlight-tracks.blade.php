...
<div class="bg-primary-light">
    <div class="max-w-screen-xl m-auto py-12 px-4">
        ...
        <div class="py-4">
            <div id="carousel">
                <div  x-data="{swiper1: null}"
                x-init="swiper1 = new Swiper($refs.swiper1, {
                    loop: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
                ...
                >
                    ...
                    <button @click="swiper1.slidePrev()" 
                    ...
                    <div class="swiper-container swiper1" x-ref="swiper1">
                    ...
                    <button @click="swiper1.slideNext()" 
