...
<div class="bg-primary-light">
    <div class="max-w-screen-xl m-auto py-12 px-4">
        ...
        <div class="py-4">
            <div id="">
                <div  x-data="{swiper2: null}"
                x-init="swiper2 = new Swiper($refs.swiper2, {
                    loop: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
                ...
                >
                    ...
                    <button @click="swiper2.slidePrev()" 
                    ...
                    <div class="swiper-container swiper2" x-ref="swiper2">
                    ...
                    <button @click="swiper2.slideNext()" 
