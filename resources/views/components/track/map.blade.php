...
<div id="map" class="h-mapmobile md:h-mapdesktop md:rounded-l-lg poiLeafletMap">
    <a target="_blank" href="{{config('geohub.web_app_deep_link')}}{{$track->id}}"><p class="absolute left-6 bottom-6 text-base px-6 py-2 bg-white text-primary font-bold rounded-lg z-1000 hover:shadow-lg duration-150">Apri percorso nella mappa interattiva</p></a>
</div>
<script>
