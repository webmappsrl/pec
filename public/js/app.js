...
window.flash = function (message) {
  return window.dispatchEvent(new CustomEvent('flash', {
    detail: message
  }));
};
...
function poiAddHighlight(e) {
  ...
  markerr.addClass('poiMarkerWithHighlight'); // markerr.css("box-shadow","0px 0px 10px 3px red");
}

function poiRemoveHighlight(e) {
  var markerr = $('.' + $(this).attr('id'));
  markerr.removeClass('poiMarkerWithHighlight'); // markerr.css("box-shadow","none");
}
